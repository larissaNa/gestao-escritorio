...
> = {
  ...
  via_administrativa: { color: 'text-sky-500', label: 'Via Administrativa', icon: FileText, variant: 'info' },
  ...
  acordo_trabalhista: { color: 'text-emerald-600', label: 'Acordo Trabalhista', icon: Award, variant: 'success' },
